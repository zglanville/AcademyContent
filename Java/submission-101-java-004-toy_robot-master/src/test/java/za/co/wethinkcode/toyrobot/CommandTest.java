...
//    @Test
//    void trimsCommandProperly() {
//        Command test = new Command();
//        assertFalse(test.isValidCommand("test"));
//        assertTrue(test.isValidCommand("forward"));
//        assertTrue(test.isValidCommand("FORWARD"));
//        assertTrue(test.isValidCommand("forward 10"));
//        assertTrue(test.isValidCommand("off"));
//        assertTrue(test.isValidCommand("off "));
//        assertTrue(test.isValidCommand("help"));
//        assertTrue(test.isValidCommand(" HELP  "));
//        assertFalse(test.isValidCommand("random"));
//    }
