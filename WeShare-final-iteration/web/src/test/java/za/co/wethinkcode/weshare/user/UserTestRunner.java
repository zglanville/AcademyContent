...
//    protected Process claimsServer;
//    protected Process expensesServer;
    ...
    @BeforeAll
    void startServer() {
//        ProcessBuilder pbClaimsServer = new ProcessBuilder("run_claims.bash");
//        ProcessBuilder pbExpensesServer = new ProcessBuilder("run_expenses.bash");
        server = new WeShareWebServer();
        server.start(0);
//        try {
////            pbClaimsServer.directory(new File("web\\src\\test\\scripts"));
////            pbExpensesServer.directory(new File("web\\src\\test\\scripts"));
////            System.out.println("-----------DIR:: " + pbClaimsServer.directory());
//            claimsServer = pbClaimsServer.start();
//            expensesServer = pbExpensesServer.start();
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
    ...
    void stopServer() {
        server.close();
//        claimsServer.destroy();
//        expensesServer.destroy();
    }
