...
public class Claim extends AbstractTransactionModelBase {
    ...
    public Claim(@JsonProperty("expense") Expense originalExpense,@JsonProperty("claimedFrom")  Person claimedFrom,@JsonProperty("amount")  Double amount,@JsonProperty("dueDate")  LocalDate dueDate) {
