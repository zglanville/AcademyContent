...
public class Expense extends AbstractTransactionModelBase {
    ...
    public Expense(@JsonProperty("amount") double amount, @JsonProperty("date") LocalDate date,
    @JsonProperty("description") String description, @JsonProperty("paidBy") Person paidBy) {
