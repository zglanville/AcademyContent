...
claim_form.onsubmit = async (e) => {
  ...
  let server = document.getElementById("claim_server").value;
  let expenseId = document.getElementById("expense_id").value;
  fd.forEach( (v,k) => {claim[k] = v;});
  let postData = {"expenseId": expenseId, "claim": claim};
